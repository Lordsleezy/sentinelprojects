...
const signalTypes: SignalType[] = ["Land Purchase", "Rezoning", "Planning Application", "Subdivision Filing", "Environmental Review", "Permit", "Groundbreaking", "Construction Start", "Utility Expansion", "Infrastructure Project"];
